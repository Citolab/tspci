...
const run = async () => {
  ...
  if (init) {
    ...
    const projectTypes = ["preact+tailwind", "typescript+tailwind", "javascript+tailwind", "typescript", "javascript"];
    ...
    if (projectType === "typescript" || projectType === "typescript+tailwind") {
    ...
    if (projectType === "javascript" || projectType === "javascript+tailwind") {
      copyDirAndReplaceInFiles(
